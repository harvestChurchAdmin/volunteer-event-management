...
router.get('/event/:eventId/export-needs.csv', isAuthenticated, adminController.exportEventNeedsCsv);
...
router.get('/event/:eventId/print', isAuthenticated, adminController.exportEventPrintView);
